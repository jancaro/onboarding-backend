...
public class ClientServiceImpl implements ClientService {
    ...
    public Map<String, Object> deleteClient(Long clientId) {
        Optional<Client> clientReview = clientRepository.findById(clientId);
        if(clientReview.isPresent()) {
            /*CarYard cardYard = clientReview.get().getCarYard();
            if(cardYard == null) {*/
                ...
                return response;
           /* } else {
                throw new TransactionNotFoundException("No se puede eliminar porque el cliente tiene asociado el patio con id "+cardYard.getId());
            }*/
        } else {
